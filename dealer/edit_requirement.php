			...
			<div class="min-drop">
				...
				<div class="drop-html">
					...
					<div class="dropdown">
						...
						<?php echo ($propertydata['property_for']==0)?'Residential':'Commercial'?>
 ...
 -->
			...
			<div class="min-drop" id="commercial_type">
				...
				<div class="menu-drop">
					...
					<div class="dropdown">
						...
						<?php echo ($propertydata['property_option']==0)?'Sell':'Rent'?>
			...
			<div class="min-drop" id="sell_type">
				...
				<div class="drop-html" >
					...
					<div class="dropdown">
						<?php if($propertydata['property_type']==0){echo 'Resale';}else if($propertydata['property_type']==1){echo 'New Booking';}else{}?>
		...
		$.ajax({
			...
			success:function(data){
				...
				console.log(data);
				 ...
				 window.location.href = 'list_requriment.php';
