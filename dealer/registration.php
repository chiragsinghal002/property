      ...
      <div class="container">
        <div class="row registration-content">
         ...
         <div class="col-sm-2"></div>
                   ...
                   <div class="reg-btn"> <a href="index.php" class="loreg">Log In</a></div>
                    </div>
          ...
          <div class="col-sm-6 submition-form">
                                ...
                                <button type="button" class="btn" onclick="login_show();">Login</button>                        
                                  ...
                                  <div class="input-container new">
                                    ...
                                    <div class="input-container star">
                                      ...
                                      <input class="input-field" type="email" placeholder="Username/Email" id="email1" name="email">
                                    ...
                                    <div class="input-container reg-city">

                                      <i class="glyphicon glyphicon-equalizer"><span></span></i>

                                      <select name="citys" class="city input-field" id="city" onchange="changecity(this.value)">
            ...
            $.ajax({
              ...
              beforeSend:function(){
                $("#register-status").html('Your Registration has been successfully');
                var fname = $("#fname").val("");
                var lname = $("#lname").val("");
            // var fullname=fname + ' ' + lname;
            var email1 = $("#email1").val("");
