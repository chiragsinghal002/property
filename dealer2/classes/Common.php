...
public  function searchresultbuy($data,$dealer_id) {  
   ...
   if($data['cat_id']==26){
    ...
    if(empty($data['price_range_min'] && $data['plot_area'] && $data['plot_size_area_value'])){
        ...
        // $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['choose_type']."' AND status='1' AND property_option=0 AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."' AND property_type!='".$property_type."'") or die(mysqli_query($this->db)); 
        $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['choose_type']."' AND status='1' AND property_option=0 AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."' AND property_type!='".$property_type."' AND dealer_id!='".$dealer_id."'") or die(mysqli_query($this->db)); 
    }else{
        $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['choose_type']."' AND price BETWEEN ".$data['price_range_min']." AND ".$data['price_range_max']." AND status='1' AND Plot_Area_Unit='".$data['plot_size_area_value']."' AND property_option=0 AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."' AND Plot_Area='".$data['plot_area']."' AND property_type!='".$property_type."' AND dealer_id!='".$dealer_id."'") or die(mysqli_query($this->db)); 
    }
    ...
    if(empty($data['price_range_min'] && $data['plot_area'] && $data['plot_size_area_value'] && $data['cons_status'] && $data['show_bkh'])){
        ...
        $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['choose_type']."' AND price BETWEEN ".$data['price_range_min']." AND ".$data['price_range_max']." AND status='1' AND Super_Built_Up_Area_Unit='".$data['plot_size_area_value']."' AND construction_status='".$data['cons_status']."' AND property_option=0 AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."' AND Super_Built_Up_Area='".$data['plot_area']."' AND Bedroom='".$data['show_bkh']."' AND property_type!='".$property_type."' AND dealer_id!='".$dealer_id."'") or die(mysqli_query($this->db)); 
    }
...
public  function searchresultrent($data) {  
  ...
  if($data['cat_id']==26){
    ...
    if(empty($data['price_range_min'] && $data['plot_area'] && $data['plot_size_area_value'])){
        ...
        $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['choose_type']."' AND price BETWEEN ".$data['price_range_min']." AND ".$data['price_range_max']." AND status='1' AND Plot_Area_Unit='".$data['plot_size_area_value']."' AND property_option=0 AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."' AND Plot_Area='".$data['plot_area']."' AND property_type='".$property_type."'") or die(mysqli_query($this->db)); 
    }
    ...
    if(empty($data['price_range_min'] && $data['plot_area'] && $data['plot_size_area_value'] && $data['cons_status'] && $data['show_bkh'])){
        ...
        $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['choose_type']."' AND price BETWEEN ".$data['price_range_min']." AND ".$data['price_range_max']." AND status='1' AND Super_Built_Up_Area_Unit='".$data['plot_size_area_value']."' AND construction_status='".$data['cons_status']."' AND property_option=0 AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."' AND Super_Built_Up_Area='".$data['plot_area']."' AND Bedroom='".$data['show_bkh']."' AND property_type='".$property_type."'") or die(mysqli_query($this->db)); 
    }
...
public  function getRequirementFromProperty($data,$property_for,$property_option) {
  ...
  if($property_for=='0'){
    ...
    if($property_option=='0'){
       if($data['cat_id']==26){
        // echo "SELECT * FROM residential_properties where property_for='".$data['property_for']."' AND price BETWEEN ".$min_price." AND ".$max_price." AND status='1' AND property_option=".$property_option." AND city='".$data['city']."' AND sector='".$data['sector']."' AND cat_id='".$data['cat_id']."'";die;
        $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['property_for']."' AND price BETWEEN ".$data['price_range_min']." AND ".$data['price_range_max']." AND status='1' AND plot_area='".$data['plot_area']."' AND Plot_Area_Unit='".$data['plot_size_area_value']."' AND property_option=0 AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."'") or die(mysqli_query($this->db)); 
    }else if($data['cat_id']==27){
        $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['property_for']."' AND Bedroom='".$data['show_bkh']."' AND price BETWEEN ".$data['price_range_min']." AND ".$data['price_range_max']." AND status='1' AND Super_Built_Up_Area='".$data['plot_area']."' AND Super_Built_Up_Area_Unit='".$data['plot_size_area_value']."' AND construction_status='".$data['cons_status']."' AND property_option=0 AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."'") or die(mysqli_query($this->db)); 
    }else{
       $result=$this->db->query("SELECT * FROM residential_properties where property_for='".$data['property_for']."' AND Bedroom='".$data['show_bkh']."' AND price BETWEEN ".$data['price_range_min']." AND ".$data['price_range_max']." AND status='1' AND plot_area='".$data['plot_area']."' AND Plot_Area_Unit='".$data['plot_size_area_value']."' AND property_option=0 AND construction_status='".$data['cons_status']."' AND city LIKE '".$data['searching']."%' OR sector LIKE '".$data['searching']."%' AND cat_id='".$data['cat_id']."'") or die(mysqli_query($this->db)); 
   }
}
}
...
public function getCategoryName($id){
   ...
   $selectuser = $this->db->query("SELECT cat_name FROM property_category  WHERE cat_id = $id") or die(mysqli_error($this->db));  
   $fetch_num=mysqli_num_rows($selectuser);
   $fetch=mysqli_fetch_array($selectuser);
   if($fetch_num>0){
      // while($fetch=mysqli_fetch_array($selectuser)){
...
public function getdealerproperty($dealer_id){
...
public function getpropertybyid($id){
   ...
   $selectproperties = $this->db->query("SELECT * FROM properties  WHERE property_id ='".$id."'") or die(mysqli_error($this->db));  
   $fetch_num=mysqli_num_rows($selectproperties);
...
{  
    ...
    { 
            //echo "ffff";die;
        $register = $this->db->query("INSERT INTO dealer SET dealer_type='Dealer',dealer_phone='".$data['phone']."',dealer_first_name='".$data['fullname']."',dealer_email='".$data['email']."',dealer_password='".$password."',dealer_createdat= '$created',dealer_modifiedat= '$created',dealer_status='0',dealer_firm_name='".$data['dealer_firm_name']."',dealer_address='".$data['dealer_address']."',city='".$data['city']."',sector='".$data['sector']."',mob_verified='1'") or die(mysqli_error($this->db));
        if($register)
        {
            // session_start();
...
{  
    ...
    $img = $realname;
    if($realname==0){
       $register = $this->db->query("update dealer SET dealer_type='Dealer',dealer_phone='".$data['dealer_phone']."',dealer_first_name='".$fname."',dealer_last_name='".$lname."',dealer_address='".$data['dealer_address']."',dealer_modifiedat= '$created' where dealer_email='$email'") or die(mysqli_error($this->db));
   }else{
...
public function UserForgotPassword($email){
    ...
    if($fetch){
        ...
        <a href="http://netmaxims.in/projects/property/dealer/changepassword.php?email= '.$fetch['dealer_email'].'">Reset</a>
        <p>Thanks</p>
        <p>Property App Team</p>
        </body>
        </html>
...
{  
    ...
    {             
     ...
     <p>Greetings! Hope you are having a good day.</p>
     <p>Password has been changed for your Property App account. You can now log in (<a href="http://netmaxims.in/projects/property/dealer/index.php">Login</a>) using your new password. </p>
...
public function otpVerification($data){
    ...
    $mail->addAddress($from, 'netmaxims');     // Add a recipient
...
public  function adminmail($subject1,$message1,$from1) 
{
    ...
    //Recipients
    $mail->setFrom('kanchan@netmaxims.in', 'netmaxims');
    $mail->addAddress($from1, 'netmaxims');     // Add a recipient
    $mail->addCC('kanchan.netmaximus@gmail.com');
    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
