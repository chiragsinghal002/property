...
if(isset($_GET['id'])){
	...
	$propertydata=$common->getpropertybyid($id);
	...
	<form id="form">
		<div class="container extrapaddng">
			...
			<div id="location_div" style="display: none;">
				...
				<div class="apprtmnt">
					<div class="typeheading">
						<p>Google Location:<span style="color: red;">*</span></p>
					</div>
					<div class="drop-html1">
			...
			<div class="apprtmnt">
				...
				<div class="drop-html1">
					<input type="number" name="price" placeholder="Exp. Price" class="ginputfield" id="price" value="" onkeyup="price_check(this.value)" name="exp_price" min="1">
