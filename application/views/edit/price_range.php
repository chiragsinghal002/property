<body>  
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Flavour</h4>
        ...
        <?php endif; ?>
                <?php echo form_open_multipart(base_url('index.php/edit/flavour/'.$flavour['flavour_id']), 'class="forms-sample needs-validation" novalidate' )?>
                 <!--  <form class="forms-sample"> -->
                    <div class="form-group">
                      <label for="flavour_name">Name</label>
                      <input type="text" name="flavour_name" value="<?= $flavour['flavour_name']; ?>" class="form-control" id="flavour_name" placeholder="Name" required="required">
                      <br>
              ...
              This field is required
                    ...
                    <div class="form-group">
                      <label for="flavour_status">Status</label>
                       <select name="flavour_status" class="form-control form-control-lg" id="flavour_status" required="required">
                         <option value="1" <?php echo ($flavour['flavour_status']==1 ? 'selected' : '');?>>Active</option>
                         <option value="0" <?php echo ($flavour['flavour_status']==0 ? 'selected' : '');?>>Inactive</option>
