<body>  
      ...
      <div class="main-panel">
        ...
        <?php endif; ?>
                <?php echo form_open_multipart(base_url('index.php/edit/property_type/'.$property_type['type_id']), 'class="forms-sample needs-validation" novalidate' )?>
                 <!--  <form class="forms-sample"> -->
                    <div class="form-group">
                      <label for="type_pro_catid">Property Category</label>
                      <!-- <input type="text" name="cuisines_name" value="<?= $cuisines['cuisines_name']; ?>" class="form-control" id="cuisines_name" placeholder="Name" required="required">
 -->
                    <select name="type_pro_catid" id="type_pro_catid" class="form-control" required="required">

                      <?php 
                        foreach ($category as $categorier) {                         
                         ?>
                      <option value="<?php echo $categorier['cat_id'];?>" <?php echo ($categorier['cat_id']==$property_type['type_pro_catid'] ? 'selected' : '');?>><?php echo $categorier['cat_name'];?></option>
                     <?php } ?>
              ...
              This field is required
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="type_name" class="form-control" id="type_name" value="<?php echo $property_type['type_name'] ;?>" placeholder="Property Type" required="required">
                      <br>
                    ...
                    <div class="form-group">
                      <label for="type_status">Status</label>
                       <select name="type_status" class="form-control form-control-lg" id="type_status" required="required">
                         <option value="1" <?php echo ($property_type['type_status']==1 ? 'selected' : '');?>>Active</option>
                         <option value="0" <?php echo ($property_type['type_status']==0 ? 'selected' : '');?>>Inactive</option>
