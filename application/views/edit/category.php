<body>  
      ...
      <div class="main-panel">
        ...
        <?php endif; ?>
                <?php echo form_open_multipart(base_url('index.php/edit/category/'.$category['cat_id']), 'class="forms-sample needs-validation" novalidate' )?>
                 <!--  <form class="forms-sample"> -->
                    <div class="form-group">
                      <label for="cat_name">Name</label>
                      <input type="text" name="cat_name" value="<?= $category['cat_name']; ?>" class="form-control" id="cat_name" placeholder="Name" required="required">
                      <br>
                    ...
                    <div class="form-group">
                      <label for="cat_status">Status</label>
                       <select name="cat_status" class="form-control form-control-lg" id="cat_status" required="required">
                         <option value="1" <?php echo ($category['cat_status']==1 ? 'selected' : '');?>>Active</option>
                         <option value="0" <?php echo ($category['cat_status']==0 ? 'selected' : '');?>>Inactive</option>
