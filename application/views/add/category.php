          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <h4 class="card-title">Add Category</h4>
                ...
                <?php echo form_open_multipart(base_url('index.php/add/category/'), 'class="forms-sample needs-validation" novalidate' )?>
                ...
                <!--  <form class="forms-sample"> -->
                  ...
                  <div class="form-group">
                    ...
                    <select name="property_type" class="form-control form-control-lg" id="property_type" required="required">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="cat_name" class="form-control" id="cat_name" placeholder="Name" required="required">
                    <br>
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" name="cat_image" class="form-control" id="cat_image" placeholder="Image" required="required">
                    <br>
                    <div class="invalid-feedback">
                    This field is required</div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select name="cat_status" class="form-control form-control-lg" id="cat_status" required="required">
