...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>index.php/listing/">
              <i class="menu-icon mdi mdi-backup-restore"></i>
          ...
          <!-- <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>index.php/listing/subcategory">
              <i class="menu-icon mdi mdi-backup-restore"></i>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>index.php/listing/subchildcategory">
              <i class="menu-icon mdi mdi-backup-restore"></i>
              <span class="menu-title">Property Options </span>
            </a>
          </li>
           ...
           <!-- <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic2">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url() ?>index.php/listing/subchildcategory">Options List</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>index.php/listing/property_type">
              <i class="menu-icon mdi mdi-backup-restore"></i>
          ...
          <!-- <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>index.php/listing/manage_property">
              <i class="menu-icon mdi mdi-backup-restore"></i>
