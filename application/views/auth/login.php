        ...
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            ...
            <div class="auto-form-wrapper">
              <?php echo form_open_multipart(base_url('index.php/auth/login/'), 'class="needs-validation" novalidate' )?>
              ...
              This field is required
                ...
                <div class="form-group">
                  <label class="label" for="dealer_password">Password</label>
                  <div class="input-group">
                    <input type="password" name="dealer_password" class="form-control" id="dealer_password
                    " placeholder="*********" value="admin$#@!" required="required">
                    <div class="input-group-append">
                      <span class="input-group-text">
                        <i class="mdi mdi-check-circle-outline"></i>
                      </span>
              ...
              This field is required
               ...
               <!--  </form> -->
                <div class="form-group d-flex justify-content-between">
                  ...
                  <a href="<?= base_url() ?>index.php/auth/forgot/" class="text-small forgot-password text-black">Forgot Password</a>
                </div>
               <!--  <div class="form-group">
                  <button class="btn btn-block g-login">
                    <img class="mr-3" src="<?= base_url() ?>public/images/file-icons/icon-google.svg" alt="">Log in with Google</button>
                </div> -->
                <!-- <div class="text-block text-center my-3">
                  <span class="text-small font-weight-semibold">Not a member ?</span>
                  <a href="<?= base_url()?>index.php/signup" class="text-black text-small">Create new account</a>
                </div> -->
